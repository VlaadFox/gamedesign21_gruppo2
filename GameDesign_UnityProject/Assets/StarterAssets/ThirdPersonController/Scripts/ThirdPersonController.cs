...
namespace StarterAssets
{
	...
	public class ThirdPersonController : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			/*if (_controller.velocity.z !=0 || _controller.velocity.x !=0)
				isMoving = true;
			else
				isMoving = false;
			...
			/*if(_controller.isGrounded == true && _controller.velocity.magnitude > 2f && audioSteps.isPlaying == false)
			{
				audioSteps.volume = Random.Range(0.8f, 1f);
